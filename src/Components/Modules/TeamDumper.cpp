...
namespace Components
{
	...
	void TeamDumper::DumpTeams()
	{
		const teamDef finalTeams[] = {
			...
			{ "marines",	 "iw3_usmc_desert",			"us_army",			"MPUI_MARINES",		"MPUI_MARINES_SHORT",	"MP_MARINES_ELIMINATED",	"MP_MARINES_FORFEITED",		"faction_128_usmc",		"faction_128_usmc_fade",	"US_",	"mp_spawn_usa",		"mp_victory_usa",		"prop_flag_american",	"prop_flag_neutral",	"objpoint_flag_american",		"misc/ui_flagbase_black",	{0.0f, 0.0f,  0.0f},	"headicon_american",	"com_plasticcase_seals", "mp_bog",			{"mptype_ally_sniper",				"mptype_ally_support",			"mptype_ally_rifleman",				"mptype_ally_engineer",				"mptype_ally_cqb",					"mptype_us_army_riot" }},
			{ "opfor",		 "iw3_opfor_desert",		"opforce_composite","MPUI_OPFOR",		"MPUI_OPFOR_SHORT",		"MP_OPFOR_ELIMINATED",		"MP_OPFOR_FORFEITED",		"faction_128_arab",		"faction_128_arab_fade",	"AB_",	"mp_spawn_opfor",	"mp_victory_opfor",		"prop_flag_opfor",		"prop_flag_neutral",	"objpoint_flag_opfor",			"misc/ui_flagbase_black", {0.6f,  0.57f, 0.41f},	"headicon_opfor",		"com_plasticcase_arab", "mp_bog",			{"mptype_axis_sniper",				"mptype_axis_support",		"mptype_axis_rifleman",			"mptype_axis_engineer",				"mptype_axis_cqb",					"mptype_opforce_comp_riot" }},
			{ "sas",		 "iw3_sas_urban",			"seals_udt",		"MPUI_SAS",			"MPUI_SAS_SHORT",		"MP_SAS_ELIMINATED",		"MP_SAS_FORFEITED",			"faction_128_sas",		"faction_128_sas_fade",		"UK_",	"mp_spawn_sas",		"mp_victory_sas",		"prop_flag_brit",		"prop_flag_neutral",	"objpoint_flag_british",		"misc/ui_flagbase_black",	{0.6f,  0.64f, 0.69f},	"headicon_british",		"com_plasticcase_taskforce141", "mp_carentan",		{"mptype_ally_urban_sniper",		"mptype_ally_urban_support",	"mptype_ally_urban_assault",		"mptype_ally_urban_recon",			"mptype_ally_urban_specops",		"mptype_seal_udt_riot" }},
			{ "russian",	 "iw3_spetsnaz_urban",		"opforce_airborne",	"MPUI_SPETSNAZ",	"MPUI_SPETSNAZ_SHORT",	"MP_SPETSNAZ_ELIMINATED",	"MP_SPETSNAZ_FORFEITED",	"faction_128_ussr",		"faction_128_ussr_fade",	"RU_",	"mp_spawn_soviet",	"mp_victory_soviet",	"prop_flag_russian",	"prop_flag_neutral",	"objpoint_flag_russian",		"misc/ui_flagbase_black", {0.58f,  0.28f, 0.28f},	"headicon_russian",		"com_plasticcase_ussr", "mp_carentan",		{"mptype_axis_urban_sniper",		"mptype_axis_urban_support",	"mptype_axis_urban_assault",		"mptype_axis_urban_engineer",		"mptype_axis_urban_cqb",			"mptype_opforce_airborne_riot" }},
			{ "sas",		 "iw3_sas_woodland",		"socom_141_forest",	"MPUI_SAS",			"MPUI_SAS_SHORT",		"MP_SAS_ELIMINATED",		"MP_SAS_FORFEITED",			"faction_128_sas",		"faction_128_sas_fade",		"UK_",	"mp_spawn_sas",		"mp_victory_sas",		"prop_flag_brit",		"prop_flag_neutral",	"objpoint_flag_british",		"misc/ui_flagbase_black",	{0.6f,  0.64f, 0.69f},	"headicon_british",		"com_plasticcase_taskforce141", "mp_pipeline",		{"mptype_ally_woodland_sniper",		"mptype_ally_woodland_support",	"mptype_ally_woodland_assault",		"mptype_ally_woodland_recon",		"mptype_ally_woodland_specops",		"mptype_tf141_forest_riot" }},
			{ "russian",	 "iw3_spetsnaz_woodland",	"opforce_airborne",	"MPUI_SPETSNAZ",	"MPUI_SPETSNAZ_SHORT",	"MP_SPETSNAZ_ELIMINATED",	"MP_SPETSNAZ_FORFEITED",	"faction_128_ussr",		"faction_128_ussr_fade",	"RU_",	"mp_spawn_soviet",	"mp_victory_soviet",	"prop_flag_russian",	"prop_flag_neutral",	"objpoint_flag_russian",		"misc/ui_flagbase_black", {0.58f,  0.28f, 0.28f},	"headicon_russian",		"com_plasticcase_ussr", "mp_pipeline",		{"mptype_axis_woodland_sniper",		"mptype_axis_woodland_support",	 "mptype_axis_woodland_rifleman",	"mptype_axis_woodland_engineer",	"mptype_axis_woodland_cqb",			"mptype_opforce_airborne_riot" }}
		};
